...
public class BookRepository {
    ...
    public Book get(int bookId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.warn("Searching for book with id " + bookId + " failed");
        }
        return null;
    }
    ...
    public long create(NewBook book, List<Genre> genresToInsert) {
        ...
        AuditLogger.getAuditLogger(BookRepository.class).audit("inserted book : (" + book.getTitle() + ", " + book.getDescription() + ", " + book.getAuthor() + ")");
        return id;
    }
